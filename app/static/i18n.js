...
const STRINGS = {
  en: {
    ...
    "nav.log": "Log", "nav.info": "Info", "nav.ai": "AI",
    ...
    "reminder.later_hint": "Until you accept it, this reminder comes back.",
    "reminder.more": "{n} more after this",
    ...
    "ai.title": "Assistant",
    "ai.intro": "Ask about check-ups, preparation or your schedule.",
    "ai.placeholder": "Type your question…",
    "ai.send": "Send",
    "ai.stub": "The assistant isn't connected yet. For now, the Info tab has preparation guides you can search.",
    "ai.note": "Not medical advice.",
    ...
    "settings.push_hint": "A pop-up you accept, plus your reminder inbox.",
  ...
  lv: {
    ...
    "nav.log": "Žurnāls", "nav.info": "Info", "nav.ai": "AI",
    ...
    "reminder.title": "Atgādinājums",
    "reminder.later": "Ne tagad",
    "reminder.later_hint": "Kamēr to nepieņemsiet, atgādinājums atkārtosies.",
    "reminder.more": "Pēc šī vēl: {n}",
    ...
    "ai.title": "Asistents",
    "ai.intro": "Jautājiet par pārbaudēm, sagatavošanos vai savu plānu.",
    "ai.placeholder": "Rakstiet savu jautājumu…",
    "ai.send": "Sūtīt",
    "ai.stub": "Asistents vēl nav pieslēgts. Pagaidām sagatavošanās ceļvežus varat meklēt sadaļā Info.",
    "ai.note": "Tas nav medicīnisks padoms.",
    ...
    "settings.push_hint": "Uznirstošs logs, kas jāpieņem, un atgādinājumu iesūtne.",
    "settings.sms": "Īsziņa",
